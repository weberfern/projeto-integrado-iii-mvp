            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div className="flex gap-4 text-[#4B6B58]">
                        <Link to="#" onClick={(e) => e.preventDefault()} className="hover:text-feira-green transition-colors"><FileText className="w-5 h-5" /></Link>
                        <Link to="#" onClick={(e) => e.preventDefault()} className="hover:text-feira-green transition-colors"><Share2 className="w-5 h-5" /></Link>
                        <Link to="#" onClick={(e) => e.preventDefault()} className="hover:text-feira-green transition-colors"><Rss className="w-5 h-5" /></Link>
                    </div>
                </div>
            </div>
        </footer>
